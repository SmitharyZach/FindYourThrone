  ...
  public: {
    Tables: {
      bathroom_photos: {
        ...
        Relationships: [
          {
            foreignKeyName: "bathroom_photos_bathroom_id_fkey"
            columns: ["bathroom_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "bathroom_photos_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
      ...
      bathrooms: {
        Row: {
          ...
          address: string | null
          attached_to_venue: boolean | null
          code: string | null
          created_at: string
        ...
        Relationships: [
          {
            foreignKeyName: "bathrooms_added_by_user_id_fkey"
      ...
      ratings: {
        ...
        Relationships: [
          {
            foreignKeyName: "ratings_bathroom_id_fkey"
            columns: ["bathroom_id"]
            isOneToOne: false
            referencedRelation: "bathrooms"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      calculate_bathroom_average_ratings: {
        Args: {
          bathroom_uuid: string
        }
        Returns: {
          privacy_avg: number
          functional_avg: number
          stocked_avg: number
          clean_avg: number
          rating_count: number
        }[]
